...
func (in *ApplicationDisruptionBudgetSpec) DeepCopyInto(out *ApplicationDisruptionBudgetSpec) {
	*out = *in
	...
	out.HookV2BasePath = in.HookV2BasePath
	if in.SupportedNodeDisruptionTypes != nil {
		in, out := &in.SupportedNodeDisruptionTypes, &out.SupportedNodeDisruptionTypes
...
func (in *NodeDisruptionSpec) DeepCopyInto(out *NodeDisruptionSpec) {
	*out = *in
	...
	in.DoNotGrantBefore.DeepCopyInto(&out.DoNotGrantBefore)
